...
// protocol data
    ...
    // gather data
    spareByte =  switchdoclabs_solarmax_payload[5];
    messageID = convertByteToLong(switchdoclabs_solarmax_payload, 6);

    SolarMAXID = switchdoclabs_solarmax_payload[10];
    SolarMAXProtocol = switchdoclabs_solarmax_payload[11];
    SolarMAXSoftwareVersion = switchdoclabs_solarmax_payload[12];
    SolarMAXType = switchdoclabs_solarmax_payload[13];

    LoadVoltage = convertByteToFloat(switchdoclabs_solarmax_payload, 14);
    InsideTemperature = convertByteToFloat(switchdoclabs_solarmax_payload, 18);
    InsideHumidity = convertByteToFloat(switchdoclabs_solarmax_payload, 22);
    BatteryVoltage = convertByteToFloat(switchdoclabs_solarmax_payload, 26);
    BatteryCurrent = convertByteToFloat(switchdoclabs_solarmax_payload, 30);
    ...
    data = data_make(
            ...
            "solarmaxid",        "SolarMAX ID",        DATA_INT, SolarMAXID,
            "solarmaxprotocol",        "SolarMAX Protocol",   DATA_INT, SolarMAXProtocol,
            "solarmaxsoftwareversion",        "SolarMAX Software Version",        DATA_INT, SolarMAXSoftwareVersion,
            "solarmaxtype",        "SolarMAX Type",        DATA_INT, SolarMAXType,
            "loadvoltage",        "Load Voltage",        DATA_DOUBLE, LoadVoltage,
            "insidetemperature",        "Inside Temperature",        DATA_DOUBLE, InsideTemperature,
            "insidehumidity",        "Inside Humidity",        DATA_DOUBLE, InsideHumidity,
