/* 
 * SwitchDoc Labs FT0300 All In One Weather Sensor Pack
 *
 */
...
switchdoclabs_weather_decode(r_device *decoder, bitbuffer_t *bitbuffer, unsigned row, unsigned bitpos)
{
    ...
    */
    ...
    uint8_t  myAveWindSpeed;
    uint8_t  myGust;
    uint8_t  myWindDirection;
    int myCumulativeRain;
...
*/
    ...
    data = data_make(
            "model",          "",             DATA_STRING, _X("SwitchDoc Labs-FT0300","SwitchDoc Labs FT0300 AIO"),
...
r_device switchdoclabs_FT0300 = {
    .name          = "SwitchDoc Labs Weather FT0300 Sensors",
